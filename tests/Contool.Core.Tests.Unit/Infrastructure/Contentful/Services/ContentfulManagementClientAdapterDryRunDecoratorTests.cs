...
public class ContentfulManagementClientAdapterDryRunDecoratorTests
{
    ...
    [Fact]
    public async Task GivenCancelledToken_WhenActivateContentTypeAsync_ThenRespectsCancellation()
    {
        // Arrange
        var contentTypeId = "test-content-type";
        var version = 1;
    ...
    [Fact]
    public async Task GivenCancelledToken_WhenDeactivateContentTypeAsync_ThenRespectsCancellation()
    {
        // Arrange
        var contentTypeId = "test-content-type";
        using var cts = new CancellationTokenSource();
    ...
    [Fact]
    public async Task GivenCancelledToken_WhenDeleteContentTypeAsync_ThenRespectsCancellation()
    {
        // Arrange
        var contentTypeId = "test-content-type";
        using var cts = new CancellationTokenSource();
    ...
    [Fact]
    public async Task GivenCancelledToken_WhenArchiveEntryAsync_ThenRespectsCancellation()
    {
        // Arrange
        var entryId = "test-entry";
        var version = 1;
    ...
    [Fact]
    public async Task GivenCancelledToken_WhenUnarchiveEntryAsync_ThenRespectsCancellation()
    {
        // Arrange
        var entryId = "test-entry";
        var version = 1;
